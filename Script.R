...
checkresiduals(model_series_de_all_access_all_agents)
...
checkresiduals(model_series_en_all_access_all_agents)
...
checkresiduals(model_series_es_all_access_all_agents)
...
# Forecast Plot
plot_forecast_series_de_all_access_all_agents =autoplot(forecast_series_de_all_access_all_agents )+ggtitle('Forecast from ARIMA model') + xlab('Time(in Weeks)') + ylab('Web Traffic Volume')
...
d = as.data.table(forecast_series_de_all_access_all_agents)
d
